...
<head>
	...
	<title>errorNullPointerException.jsp</title>
...
<p><br/></p>
<div class="container">
	<h2>에러 발생시 호출되는 페이지입니다(errorNullPointerException.jsp)</h2>
	<hr/>
	<div class="img-fluid">
		<img src="${ctp}/pageImg/errorNullPointerException.jpg" class="img-fluid" />
	</div>	
	<hr/>
