...
<p><br/></p>
<div class="container">
	<form name="myform" method="post" action="${ctp}/admin/adminNoticeBoardInput" enctype="multipart/form-data">
        ...
        <h1 class="text-muted">
		 ...
		 <div class="mt-3 p-3 bg-white rounded shadow"> <!-- 글쓰기 부분 -->
		 	<div class="d-flex justify-content-between align-items-center">
				<div>
					<span class="text-success fs-2"><i class="bi bi-pencil-square"></i> 글쓰기</span>
				</div>
        <div class="input-group w-25">
		 ...
		 <div class="mt-3 p-3 bg-white rounded shadow">
			 ...
			 <div id="fileList" class="mt-1">
			 </div>
			 <div class="d-flex justify-content-around align-items-center input-group mt-3">
			 	<span class="input-group-text">정보 공개 여부</span>
			 	<span class="fs-5">
				 	<input type="radio" name="openSw" id="openSw1" value="공개" class="form-check-input" checked />
			 	  <label class="form-check-label" for="openSw1">
	 				 공개
					</label>
			 	</span>
			 	<span class="fs-5">
				 	<input type="radio" name="openSw" id="openSw2" value="비공개" class="form-check-input" />
	     ...
	     <div class="d-flex justify-content-around align-items-center mt-3">
	    	<c:if test="${sLevel ==0 || SMid =='admin'}">
		    	...
		    	<button type="reset" class="btn btn-warning w-25">
		    		다시작성하기
		    	</button>
